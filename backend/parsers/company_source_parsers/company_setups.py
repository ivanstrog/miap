...
from parsers.company_getters.orgma_getter import orgma_link_getter
...
from parsers.page_parsers.orgma_page_parser import orgma_page_parser


COMPANY_SETUPS = [
    ("Оренбургский государственный медицинский университет", orgma_link_getter.get_links, orgma_page_parser),
